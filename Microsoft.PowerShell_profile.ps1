$githubUser = "David-Bouhadana" # Change this here if you forked the repository.
$name= "David" # Change this to your name.
...
$OhMyPoshConfig = "https://raw.githubusercontent.com/David-Bouhadana/oh-my-posh/main/themes/$OhMyPoshConfigFileName" # URL of the OhMyPosh config file, make sure to use the last part of the raw lik, (stands for the filename) in the variable on the line below
